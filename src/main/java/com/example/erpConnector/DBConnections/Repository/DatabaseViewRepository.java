...
@Repository
public interface DatabaseViewRepository extends JpaRepository<DatabaseView,Integer> {
    ...
    @Query(value = "select tab.table_schema as database_schema,tab.table_name as table_name," +
            ...
            "'performance_schema','sys') and tab.table_schema = 'customer'  ",nativeQuery = true)
